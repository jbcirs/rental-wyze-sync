...
# @app.route(route="property_list_two", methods=[func.HttpMethod.GET], auth_level=func.AuthLevel.FUNCTION)
# def property_list_two(req: func.HttpRequest) -> func.HttpResponse:
